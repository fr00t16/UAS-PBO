                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Selamat datang <?php echo $_SESSION['username']; ?>!!! Di User Control Panel</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Home</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">User control panel home</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <?php if($pengguna->IsAdmin($_SESSION['username'])) {?>
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="card border-3 border-top border-top-primary">
                                        <div class="card-body">
                                            <h5 class="text-muted">Total pengguna di database(Admin)</h5>
                                            <div class="metric-value d-inline-block">
                                                <h1 class="mb-1"><?php echo $pengguna->TotalPendaftar();?></h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Uang Ingame</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $pengguna->dolarformat($_SESSION['username'], "uang");?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Diamond</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $pengguna->dolarformat($_SESSION['username'], "diamond");?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Kelamin</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $pengguna->Kelamin($_SESSION['username']);?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
