<?php
  ...
  if(isset($_POST['changepass']))
  {
    ...
    if(empty($_POST['opassword']))
     echo "<script>alert('Form old password tidak boleh kosong!');</script><script>window.history.back()</script>";
    else if(empty($_POST['npassword']))
     echo "<script>alert('Form new password tidak boleh kosong!');</script><script>window.history.back()</script>";
    else if(empty($_POST['renpassword']))
     echo "<script>alert('Form Retype new password tidak boleh kosong!');</script><script>window.history.back()</script>";
    else
    {
      ...
      $pengguna->Gantipass($oldpw, $npassword, $renpassword);
    }
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Setting account <?php echo $_SESSION['username']; ?></h2>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" id="changepass" data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="opassword">Password yang sekarang</label>
                                            <input id="opassword" name="opassword" type="password" required="" placeholder="Password" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="npassword">Password baru</label>
                                            <input id="npassword" name="npassword" type="password" placeholder="Password Baru" required="" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="renpassword">Retype Password bau</label>
                                            <input id="renpassword" name="renpassword" type="password" required="" placeholder="Retype Password Baru" class="form-control">
                                        </div>
                                        <div class="row">
