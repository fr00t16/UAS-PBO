                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">(Admin) log login</h2>
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>IP</th>
                                                <th>Waktu login</th>
                                                <th>Perangkat webbrowser</th>
                                                <th>Perangkat keras</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                          <?php $i=0; foreach($pengguna->Pilihloglogin() as $data) 
                                          {  $i++; ?>
                                          <tr>
                                            <td><?php echo @$i ?></td>
                                            <td><?php echo $pengguna->Getnamefromid($data['id_pengguna']);?></td> 
                                            <td><?php echo $data['ip'];?></td>
                                            <td><?php echo $data['waktu'];?></td> 
                                            <td><?php echo $data['perangkat_lunak'];?></td> 
                                            <td><?php echo $data['perangkat_keras'];?></td> 
                                          </tr>
                                          <?php } ?> 
                                        </tbody>
                                    </table>
